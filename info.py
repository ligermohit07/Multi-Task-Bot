...
PICS = (environ.get('PICS', 'https://files.catbox.moe/26slv0.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002543359852') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002678697154')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'WabX_Support') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'Thanks For Close')
...
LANGUAGES = ["hindi", "hin" ,"english", "eng", "tamil", "tam", "telugu", "tel"]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://soft-consuelo-telegram-features-273246fb.koyeb.app/")
